<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditarCliente.aspx.cs" Inherits="Vistas.EditarCliente" %>
    ...
    <div class="container justify-content-center">
        ...
        <div class="card container-fluid" style="width: 65%;">
            ...
            <div>
                ...
                <asp:Button runat="server" Text ="Modificar Cliente" CssClass="btn btn-success" ID="btnAgregarCliente" OnClick="btnAgregarCliente_Click"/>
            </div>
            <div class="mb-3"></div>
        </div>
    </div>
